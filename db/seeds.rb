User.create!(
  ...
  bio: `
  Storyfinder, Citizen, Sock Hater, Perpetual Escapist, Unregulated Banker.
  A human. Being.
  `,
  password: "password",
...
User.create!(
  ...
  email: "mia@test.com",
  bio: `
  Educator, Dancer, Oscar-loser, Information Addict, Ned Stark"s Neck Stump.
...
User.create!(
  ...
  bio: `Filmmaker, Explorer, Political Activist, Dollar Store Owner,
  Cat Stroker. I don"t believe in showers`,
  password: "password",
  password_confirmation: "password",
